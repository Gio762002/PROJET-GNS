...
def generate_eBGP_neighbour_info(lst_as):
    neighbour_info = {}
...
"""
def as_enable_BGP(lst_as, loopback_plan):# loopback_plan: result of fctr.distribute_loopback(lst_as)
    neighbour = generate_eBGP_neighbour_info(lst_as)
    for As in lst_as:
